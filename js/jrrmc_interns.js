...
// --- Image modal logic for interns page ---
(function () {
  ...
  // Target images on interns page
  const pageImages = document.querySelectorAll('.intern-photo img, .intern-photo-col img, .intern-photo-list img');
